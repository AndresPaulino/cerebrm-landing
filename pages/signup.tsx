...
const SignUp: NextPage = () => {
  ...
  return (
    <Container title={`Signup for CEREB[RM]`}>
      <div className='min-h-[60rem] flex justify-center items-start'>
        ...
        <div className='px-10 py-20 rounded-xl bg-white shadow-lg w-[30rem] mt-10 md:mt-14 mx-4 relative z-10'>
          ...
          <h1 className='my-8 text-xl text-zinc-700 text-center'>Signup for CEREB[RM]</h1>
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              name='password'
            />
            <Button type='submit' as='button' variant='large' className='rounded-2xl py-2 w-full' onClick={handleSubmit}>
              Sign up
            </Button>
          </form>
          ...
          <Link href='/signin' className='text-gray-600 block mt-4 text-xs text-center'>

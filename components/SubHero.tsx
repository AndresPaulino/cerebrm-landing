...
export const SubHero = () => {
  ...
  return (
    <div id='features' className='px-4 bg-zinc-900 py-20 md:py-40 relative group' onMouseMove={onMouseMove}>
      <div className='absolute w-96 h-96 -left-20 -top-20 bg-gradient-to-t from-[#ffff] to-[#CFFCC1] blur-3xl rounded-full opacity-20' />
      <div className='max-w-2xl md:mx-auto md:text-center xl:max-w-none'>
        <h2 className='font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl'>Features</h2>
        {/* <p className='mt-6 text-lg tracking-tight text-blue-100'>
          A.I. Powered (SaaS) that autonomously deploys & executes
          <br />
          Investment & Trading strategies generated by asset managers,
          <br />
          investors, and traders. While adhering to capital and risk management requirements.
        </p> */}
      </div>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-w-5xl mx-auto gap-20 my-20 md:my-40 px-4'>
        {features.map((feature: FeatureType, idx: number) => (
          <Card key={`feature-${idx}`} heading={feature.heading} description={feature.description} icon={feature.icon} />
        ))}
      </div>
    </div>
  );
